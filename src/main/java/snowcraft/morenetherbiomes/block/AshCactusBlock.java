...
extends Block {
    ...
    public AshCactusBlock(Settings settings) {
        super(settings);
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return (blockState2.isOf(ModBlocks.ASH_CACTUS) || blockState2.isOf(ModBlocks.ASH_BLOCK)) && !world.getBlockState(pos.up()).isLiquid();
    }
