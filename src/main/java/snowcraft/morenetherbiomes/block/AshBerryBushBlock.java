...
public class AshBerryBushBlock
        extends PlantBlock
    ...
    public AshBerryBushBlock(AbstractBlock.Settings settings) {
        super(settings);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.ASH_BERRIES);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            net.minecraft.block.SweetBerryBushBlock.dropStack(world, pos, new ItemStack(ModItems.ASH_BERRIES, j + (bl ? 1 : 0)));
